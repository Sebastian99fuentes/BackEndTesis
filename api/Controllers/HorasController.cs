...
namespace api.Controllers
{
    ...
    public class HorasController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetById([FromRoute]int id)
        {
            ...
            // var hora = await _stockRepo.GetByIdAsync(id);
            // if (hora == null)
            // {
            //     return NotFound();
            // }
        ...
        //     var HoraModel = HoraDto.ToHorasFromCreateDto();
        //    await _stockRepo.CreateAsync(HoraModel);
        //     return CreatedAtAction(nameof(GetById), new {id = HoraModel.Id}, HoraModel.ToHoras());
        }  
        ...
        public async Task<IActionResult> Update([FromRoute]int id, [FromBody] UpdateHoraRequestDto updateDto)
        {
           ...
           await _context.SaveChangesAsync();
            ...
            // var HoraModel = await _stockRepo.UpdateAsync(id, updateDto); 
            //  if (HoraModel == null)
            // {
            //     return NotFound();
            // } 
        ...
        public async Task<IActionResult> Delete ([FromRoute] int id)
        {
           ...
           await _context.SaveChanges();
            ...
            // var HoraModel = await _stockRepo.DeleteAsync(id);
            //  if (HoraModel == null)
            // {
            //     return NotFound();
            // } 
